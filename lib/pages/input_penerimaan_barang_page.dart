...
class _InputPenerimaanBarangPageState extends State<InputPenerimaanBarangPage> {
  ...
  void initState() {
    ...
    // Listen to controller changes so page rebuilds when qty etc. changes
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: _controller.selectedGudangName.isEmpty
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                      _controller.selectedGudangName,
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 16,
                                        fontWeight: FontWeight.w600,
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                      _controller.selectedGudangKode,
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 16,
                                        fontWeight: FontWeight.w600,
  ...
  Widget _buildDetailsSection() {
    ...
    final isPo = _controller.selectedOrigin == 'purchaseorder';
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      isPo ? 'Detail Item PO (Adjust Qty)' : 'Detail Barang',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                        fontWeight: FontWeight.w600,
                ...
                children: [
                  if (_controller.scannedItems.isNotEmpty) ...[
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                      decoration: BoxDecoration(
                        color: (isPo || _controller.areAllItemsScanned()) ? Colors.green[800] : Colors.blue[800],
                        borderRadius: BorderRadius.circular(12),
                      ),
                      child: Text(
          ...
          if (_controller.scannedItems.isNotEmpty)
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isScanned = isPo || _controller.isItemScanned(item.kodeBarang);
                return Card(
                  color: isPo ? Colors.grey[850] : (isScanned ? Colors.green[900] : Colors.grey[850]),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // 1. Top Row: Icon + Kode Barang (Full Width across top!)
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                item.kodeBarang != null && item.kodeBarang!.isNotEmpty
                                    ? item.kodeBarang!
                                    : 'Item #${item.itemBarangId ?? item.id ?? (index + 1)}',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15,
                        ...
                        // 3. Bottom Row: Qty Terima Adjuster (Left) + Delete Button (Right)
                        Row(
